...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h1 class="section-heading"><i class="bi bi-book"></i> Novo Livro</h1>
        <p class="section-sub">Preencha os dados para cadastrar um novo título</p>
    </div>
</div>
        ...
        <form action="{{ route('livros.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="mb-4">
                    ...
                    <input type="text" name="titulo" class="lib-input" value="{{ old('titulo') }}" placeholder="Ex.: Dom Quixote" required>
                </div>
